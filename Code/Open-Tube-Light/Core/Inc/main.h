...
#define PSU_5V_PG_Pin GPIO_PIN_7
#define PSU_5V_PG_GPIO_Port GPIOE
#define PSU_5V_EN_Pin GPIO_PIN_8
#define PSU_5V_EN_GPIO_Port GPIOE
#define USBC_PG_Pin GPIO_PIN_1
#define USBC_PG_GPIO_Port GPIOE
